...
export interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'secondary' | 'cyan' | 'orchid' | 'gold' | 'ghost';
  size?: 'sm' | 'md' | 'lg';
  isLoading?: boolean;
  isSuccess?: boolean;
  isError?: boolean;
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles = 'inline-flex items-center justify-center font-bold tracking-wide transition-all duration-200 rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-iris-cyan focus-visible:ring-offset-2 focus-visible:ring-offset-iris-ink active:scale-[0.98] disabled:pointer-events-none disabled:opacity-40';
    ...
    const variants = {
      ...
      orchid: 'bg-iris-orchid text-white hover:bg-iris-orchid/90 hover:shadow-[0_0_25px_rgba(167,123,255,0.5)]',
